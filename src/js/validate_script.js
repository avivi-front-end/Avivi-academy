var validationMessages = {
    ...
    username:{required: "Вы пропустили", minlength: "минимум 6", maxlength: "превышает 72",},
    ...
    if ($form.length && $form.attr('novalidate') === undefined) {
        ...
        valic = $form.validate({
            rules:{
                ...
                username:{required: true, minlength: 5, maxlength: 72},
...
$(document).ready(function(){
    if($('form#valid-form').length > 0) validation('form#valid-form');
   Maskedinput();
});